...
var getJobs = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch('https://tp--asincronismo-default-rtdb.firebaseio.com/jobs.json')];
            case 1:
                response = _a.sent();
...
var editJob = function (data) { return __awaiter(_this, void 0, void 0, function () {
    var param, id;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
